...
# DBTITLE 1,Use Case
# MAGIC %md
# MAGIC CMS Schemas for **MRF** (Machine Readable File) are built using a single json object which spark by default cannot split. Reading these large files often results in Out of Memory errors. This parser serves to transform any array objects under the header into multiple splittable lists that can be parsed.
# MAGIC
# MAGIC #### Operation which we are going to perform:
# MAGIC - **Bronze**
...
# MAGIC - **Gold**
# MAGIC   Query Meeting 2023, 2024 Prive comparision CMS Mandate
# MAGIC
# MAGIC
# MAGIC #### Where to get MRF Files?
# MAGIC Here are some of the USA's larger payers and landing page
# MAGIC
# MAGIC * [UHG](https://transparency-in-coverage.uhc.com/)
...
# MAGIC %sh
# MAGIC # clean up any old data files
# MAGIC rm -rf /dbfs/tmp/hls_dev_payer_transparency.db/

# COMMAND ----------

dbutils.fs.rm("dbfs:/tmp/hls_dev_payer_transparency.db/", True)

# COMMAND ----------

# MAGIC %md ## Downloading files
...
# MAGIC mkdir -p /dbfs/tmp/hls_dev_payer_transparency.db/raw_files/2022/
# MAGIC wget -O /dbfs/tmp/hls_dev_payer_transparency.db/raw_files/2022/2022-12-01_UMR--Inc-_Third-Party-Administrator_ENCORE-ENTERPRISES-AIRROSTI-DCI_TX-DALLAS-NON-EVALUATED-GAP_-ENC_NXBJ_in-network-rates.json.gz  https://uhc-tic-mrf.azureedge.net/public-mrf/2022-12-01/2022-12-01_UMR--Inc-_Third-Party-Administrator_ENCORE-ENTERPRISES-AIRROSTI-DCI_TX-DALLAS-NON-EVALUATED-GAP_-ENC_NXBJ_in-network-rates.json.gz

# COMMAND ----------

# DBTITLE 0,Unzipping files
# MAGIC %sh
# MAGIC # unzip in dbfs
# MAGIC gunzip -cd /dbfs/tmp/hls_dev_payer_transparency.db/raw_files/2022-12-01_UMR--Inc-_Third-Party-Administrator_ENCORE-ENTERPRISES-AIRROSTI-DCI_TX-DALLAS-NON-EVALUATED-GAP_-ENC_NXBJ_in-network-rates.json.gz  > /dbfs/tmp/hls_dev_payer_transparency.db/raw_files/2022-12-01_UMR--Inc-_Third-Party-Administrator_ENCORE-ENTERPRISES-AIRROSTI-DCI_TX-DALLAS-NON-EVALUATED-GAP_-ENC_NXBJ_in-network-rates.json
...
# MAGIC %sh
# MAGIC # Download to DBFS storage
# MAGIC mkdir -p /dbfs/tmp/hls_dev_payer_transparency.db/raw_files/2023/
# MAGIC wget -O /dbfs/tmp/hls_dev_payer_transparency.db/raw_files/2023/2023-09-01_UMR--Inc-_Third-Party-Administrator_ENCORE-ENTERPRISES-AIRROSTI-DCI_TX-DALLAS-NON-EVALUATED-GAP_-ENC_NXBJ_in-network-rates.json.gz  https://uhc-tic-mrf.azureedge.net/public-mrf/2023-09-01/2023-09-01_UMR--Inc-_Third-Party-Administrator_ENCORE-ENTERPRISES-AIRROSTI-DCI_TX-DALLAS-NON-EVALUATED-GAP_-ENC_NXBJ_in-network-rates.json.gz

# COMMAND ----------

# MAGIC %sh
# MAGIC # unzip in dbfs
# MAGIC gunzip -cd /dbfs/tmp/hls_dev_payer_transparency.db/raw_files/2023/2023-09-01_UMR--Inc-_Third-Party-Administrator_ENCORE-ENTERPRISES-AIRROSTI-DCI_TX-DALLAS-NON-EVALUATED-GAP_-ENC_NXBJ_in-network-rates.json.gz  > /dbfs/tmp/hls_dev_payer_transparency.db/raw_files/2023/2023-09-01_UMR--Inc-_Third-Party-Administrator_ENCORE-ENTERPRISES-AIRROSTI-DCI_TX-DALLAS-NON-EVALUATED-GAP_-ENC_NXBJ_in-network-rates.json

# COMMAND ----------

# MAGIC %sql
# MAGIC -- create database
# MAGIC create database if not exists hls_dev_transparency;

# COMMAND ----------

# Location of unzipped json file
source_data = "dbfs:/tmp/hls_dev_payer_transparency.db/raw_files/2023/2023-09-01_UMR--Inc-_Third-Party-Administrator_ENCORE-ENTERPRISES-AIRROSTI-DCI_TX-DALLAS-NON-EVALUATED-GAP_-ENC_NXBJ_in-network-rates.json"
...
#Create tables from JSON structures for ETL development in SQL
...
# MAGIC %md
# MAGIC ### Silver (Create relational tables from nested array structures)
